...
doctor = client.get_database("remoteremody").doctors
patients = client.get_database("remoteremody").patients
feedback = client.get_database("remoteremody").feedback
...
def contact():
    ...
    try:
        ...
        msg = Message(
            ...
            sender=data['email'],
            recipients=["RemoteRemedy489@gmail.com"],
            body=f"""
...
# model = pickle.load(open('../models/ExtraTrees', 'rb'))
...
# print(len(symptoms)) 
# desc=pd.read_csv("../models/symptom_Description.csv")
# prec=pd.read_csv("../models/symptom_precaution.csv") 

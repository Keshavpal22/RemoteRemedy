      ...
      <section className="bg-[#f4f7fb] shadow-md py-12 px-5">
        <div className="max-w-7xl mx-auto flex justify-between items-center gap-10">
          <div className="max-w-[50%]">
            <h2 className="text-4xl text-gray-800 mb-5">Welcome to Remote Remedy</h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-5">
              Remote Remedy is an innovative platform designed to bridge the gap between healthcare professionals and patients. Our website connects users with doctors, provides access to medications, and offers predictive health tools, all in one place.
            </p>
            <Link 
              to="/learn-more" 
